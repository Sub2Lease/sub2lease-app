  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className={`flex gap-2 px-6 py-2 bg-white rounded-full shadow hover:bg-gray-100 transition whitespace-nowrap ${selected !== "any" ? "ring-2 ring-foreground/30" : ""}`}>
          {label}
        </button>
      </DropdownMenuTrigger>
